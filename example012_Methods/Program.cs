...
// {
//     return DateTime.Now.Year; //- обязательное использование оператора return(с англ. - вернуть)
// }
...
// синтаксически он просто собирает в себе всё в кучу (счётчик, увеличение чего-то в теле цикла и проверку условия): for (int i = 0; i < count; i++)
...
//     return result;
// }
// string NewText = Replace(text, ' ', '|'); // меняем пробелы на чёрточки |
...
void SelectionSort(int[] array)  //  вводим метод для упорядочивания массива
{
    ...
    {
        int minPosition = i;  // вводим искомую минимальную позицию (сперва она будет равна значению индекс 0(нулевого))
        for(int j = i + 1; j < array.Length; j ++)           //
        {                                                   // Этот блок кода будет искать минимальный элемент
